        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 32),
              _buildAnimatedItem(6, _buildCitationsSection(context)),
            ...
            Row(
              children: [
                IconButton(
                  ...
                  icon: Icon(Icons.info_outline_rounded, color: AppTheme.primary.withValues(alpha: 0.6), size: 18),
                ),
                IconButton(
